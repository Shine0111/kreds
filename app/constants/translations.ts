...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    settings: {
      ...
      features: {
        ...
        description: "Unlock additional features and functionality.",
  ...
  fr: {
    ...
    settings: {
      ...
      features: {
        ...
        description:
          "Débloquez des fonctionnalités et des fonctions supplémentaires.",
    ...
    home: {
      ...
      noCodeFoundMessage:
        "Impossible de trouver un code valide à 14 chiffres dans l'image.",
      dialCodeCopied: "Code de numérotation copié dans le presse-papiers !",
  ...
  mg: {
    ...
    settings: {
      ...
      theme: {
        title: "Endrika",
        description: "Safidio ny endrika tianao ho an'ny fampiharana.",
        light: "Endrika mazava",
        dark: "Endrika maizina",
        system: "Araka ny rafitra",
      },
      language: {
        title: "Fiteny",
        description: "Safidio ny fiteny tianao ho an'ny fampiharana.",
        malagasy: "Malagasy",
        english: "Anglisy",
        french: "Frantsay",
      },
      features: {
        title: "Endri-javatra fanampiny",
        description: "Hanokatra endri-javatra sy fiasa fanampiny.",
        autoDetect: "Mamantatra ho azy ny mpandraharaha",
        saveHistory: "Mitahiry ny tantaran'ny scan",
        quickAccess: "Fomba haingana hidirana",
      },
      contact: {
        title: "Mifandraisa aminay",
        description: "Mifandraisa aminay mba hahazoana fanampiana na hevitra.",
        developedBy: "Namboarina avy amin'ny",
      },
    },
    common: {
      version: "Kinova",
      allRightsReserved: "© 2025 Shine Randriamialison. Zo rehetra voaaro.",
      copyrightDetails:
        "Tsy azo atao ny mandika, manaparitaka, na manova tsy nahazoana alalana ity fampiharana ity na ny votoatiny rehetra.",
      ok: "OK",
      cancel: "Ajanona",
      error: "Hadisoana",
      processing: "Miasa...",
    ...
    home: {
      ...
      noCodeFoundMessage:
        "Tsy nahita kaody 14 isa manan-kery tao amin'ny sary.",
      dialCodeCopied: "Kaody nalaina tao amin'ny clipboard!",
      openDialer: "Hanokatra ny dialer",
      noAd: "Tsy misy doka",
    },
    errors: {
      emailFailed: "Hadisoana",
      emailFailedMessage:
